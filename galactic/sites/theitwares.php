...
function theitwares($searchQuery)
{
   
    $searchQuery=urlencode($searchQuery);
    $searchUrl='http://www.theitwares.com/advanced_search_result.php?keywords='.$searchQuery.'&osCsid=363f85596e45b5b8a20525516ceb1356&x=27&y=-2';
    ...
    if($firstLink!="")  //if number of results is less then there will be no fk-button-blue
    {
        ...
        $newLink='http://www.theitwares.com'.$firstLink->href;
       ...
       foreach($html->find('div.fk-srch-item') as $result) 
       {
            ...
            $item['buyNow']='http://www.theitwares.com'.$buyNowTemp;
            $item['site']="theitwares";
            $items[] = $item;
       }
    }
    else
