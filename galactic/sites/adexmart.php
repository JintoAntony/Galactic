...
function adexmart($searchQuery)
{
   
    $searchQuery=urlencode($searchQuery);
    $searchUrl='http://adexmart.com/search?orderby=position&orderway=desc&search_query='.$searchQuery.'&submit_search=Search';
    ...
    if($firstLink!="")  //if number of results is less then there will be no fk-button-blue
    {
        ...
        $newLink='http://www.adexmart.com'.$firstLink->href;
       ...
       foreach($html->find('div.fk-srch-item') as $result) 
       {
            ...
            $item['buyNow']='http://www.adexmart.com'.$buyNowTemp;
            $item['site']="adexmart";
            $items[] = $item;
       }
    }
