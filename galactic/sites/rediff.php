...
function rediff($searchQuery)
{
   
    $searchQuery=urlencode($searchQuery);
    $searchUrl='http://shopping.rediff.com/shopping/index.html#!'.$searchQuery;
    ...
    if($firstLink!="")  //if number of results is less then there will be no fk-button-blue
    {
        ...
        $newLink='http://www.shopping.rediff.com'.$firstLink->href;
       ...
       foreach($html->find('div.fk-srch-item') as $result) 
       {
            ...
            $item['buyNow']='http://www.shopping.rediff.com'.$buyNowTemp;
            $item['site']="rediff";
            $items[] = $item;
       }
    }
