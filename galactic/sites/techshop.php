...
function techshop($searchQuery)
{
   
    $searchQuery=urlencode($searchQuery);
    $searchUrl='http://techshop.in/store/advanced_search_result.php?keywords='.$searchQuery.'&x=3&y=11';
    ...
    if($firstLink!="")  //if number of results is less then there will be no fk-button-blue
    {
        ...
        $newLink='http://www.techshop.in'.$firstLink->href;
       ...
       foreach($html->find('div.fk-srch-item') as $result) 
       {
            ...
            $item['buyNow']='http://www.techshop.in'.$buyNowTemp;
            $item['site']="techshop";
            $items[] = $item;
       }
    }
