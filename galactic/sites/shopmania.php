...
function shopmania($searchQuery)
{
   
    $searchQuery=urlencode($searchQuery);
    $searchUrl='http://www.shopmania.com/shopping?q='.$searchQuery;
    ...
    if($firstLink!="")  //if number of results is less then there will be no fk-button-blue
    {
        ...
        $newLink='http://www.shopmania.com'.$firstLink->href;
       ...
       foreach($html->find('div.fk-srch-item') as $result) 
       {
            ...
            $item['buyNow']='http://www.shopmania.com'.$buyNowTemp;
            $item['site']="shopmania";
            $items[] = $item;
       }
    }
